                    ...
                    <form action="{{ route('owner.images.update',  ['image' => $image->id ]) }}" method="POST" >
                        ...
                        <div class="-m-2">
                            ...
                            <div class="p-2 w-full flex justify-around mt-4">
                                <button type="button" onclick="location.href='{{ route('owner.images.index') }}'" class="bg-gray-100 border-0 py-2 px-8 focus:outline-none hover:bg-gray-400 rounded text-lg">戻る</button>
